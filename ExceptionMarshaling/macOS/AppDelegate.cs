...
public class AppDelegate : NSApplicationDelegate {
	...
	public override void DidFinishLaunching (NSNotification notification)
	{
		...
		var buttonSize = new CGSize (boxSize.Width - 50, cellSize.Height);
		var buttonLocation = new CGPoint (25, 0);
		var buttonFrame = new CGRect (buttonLocation, buttonSize);
		var throwManagedException = new NSButton (buttonFrame);
		throwManagedException.Title = "Throw managed exception";

		var marshalManagedModeMatrix = new NSMatrix (new CGRect (0, 0, managedBox.Frame.Width - 25, cellSize.Height * 6 + 10), NSMatrixMode.Radio, protoCell, 6, 1);
		...
		var threadManagedMatrix = new NSMatrix (new CGRect (0, 0, managedBox.Frame.Width - 25, cellSize.Height * 3 + 10), NSMatrixMode.Radio, protoCell, 3, 1);
